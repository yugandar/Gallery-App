            ...
            <div class="col-md-6">
                ...
                <div class="form-group float-label-control">
                    <div class="radio-inline">
                        <label>
                            <input type="radio" name="user_maritialstatusr" id="optionsRadios1" value="Married" checked>Married</label>
                    </div>
                    <div class="radio-inline">
                        <label>
                            <input type="radio" name="user_maritialstatusr" id="optionsRadios1" value="single">single</label>
                    </div>
                </div>
                <div class="form-group float-label-control">
