...
<?php
    if($_POST){
        ...
        $sql=mysqli_query($database,"select * from user where user_firstname like '%$query%' or `user_dob` LIKE '%query%' or `user_profession` LIKE '%query%' order by user_id");
...
<?php
    if($number > 1){
?>
        <h3 class="panel-title"><?php  ?> Results for "<?php echo $query; ?>"</h3>
<?php
    }
    else{
?>
         <h3 class="panel-title"><?php ?> Result for "<?php echo $query; ?>"</h3>
<?php
    }
?>
